...
impl PopupMenuItem {
    pub fn new<I: Into<Icon>>(
        ...
        let icon_el = icon_
            .svg_element()
            .expect("PopupMenuItem: Unable to create image")
        ...
        {
            {
                let mut locked = parent
                    .items
                    .lock()
                    .expect("Unable to lock popup_menu/parent.items for new child");
    ...
    pub fn set_position(&self, x: f32, y: f32) -> Result<()> {
        self.element
            .set_attribute("style", &format!("--menu-x: {x}px; --menu-y: {y}px;"))?;
        Ok(())
    }
    fn get_id() -> u8 {
        static mut ID: u8 = 0;
    ...
    pub fn with_callback(
        self,
        callback: Box<dyn Fn(&PopupMenuItem) -> Result<()>>,
    ) -> Result<Self> {
        ...
        self.element
            .add_event_listener_with_callback("click", callback_.as_ref())?;
        {
            let mut locked = self
                .click_listener
                .lock()
                .expect("Unable to lock popu_pmenu.click_listener");
...
impl PopupMenu {
    ...
    fn set_circle_size(&self, size: i64) -> Result<()> {
        //self.size = size;
        self.circle_el
            .set_attribute("d", &Self::create_circle_path(self.width, size))?;
        Ok(())
    }
    ...
    pub fn update(&self, size: i64) -> Result<()> {
        ...
        let items = self
            ...
            .items
            .lock()
            .expect("Unable to lock popup menu items");
    ...
    */
    ...
    pub fn create_item<T: Into<MenuCaption>, I: Into<Icon>>(
        parent: &PopupMenuItem,
        text: T,
        icon: I,
