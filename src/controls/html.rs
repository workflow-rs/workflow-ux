...
impl Html {
    ...
    pub fn new(pane : &ElementLayout, _attributes: &Attributes, _docs : &Docs) -> Result<Html> {  // pane-ctl
    ...
    pub fn set_html(&self, html : &workflow_html::Html) -> Result<()> { //(Vec<Element>, BTreeMap<String, Element>)) -> Result<()> {
