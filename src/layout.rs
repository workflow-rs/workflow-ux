...
impl ElementLayout {
    ...
    pub fn element(&self) -> Element {
        // self.element.clone()
        let inner = self.inner().expect("ElementLayout::element() failure to lock inner");
        // Ok(
            inner.element.clone()
        // )
    ...
    pub fn root_element(&self) -> Result<Element> {
        ...
        let root = inner.element.parent_element()
    ...
    pub fn try_new_for_html() -> Result<ElementLayout> {
        ...
        element.set_class_name(&format!("{}-container", ElementLayoutStyle::Html.get_type()));
    ...
    pub fn new(parent_layout : &ElementLayout, layout_style: ElementLayoutStyle, attributes : &Attributes) -> Result<ElementLayout> {
    ...
    pub fn append_child(&self, child: &Element, attributes : &Attributes, docs : &Docs) -> Result<()> {
        ...
        let container = match &layout.layout_style {
            ...
            ElementLayoutStyle::Pane => {
                None
            },
            ElementLayoutStyle::Panel => {
                None
            },
            ElementLayoutStyle::Page => {
                None
            },
            ElementLayoutStyle::Group => {
                None
            },
            ElementLayoutStyle::Html => {
                None
            },
        };
    ...
    pub fn get_stage_footer(&self)->Result<stage_footer::StageFooter>{
        ...
        let footer_node = layout.element.parent_element()
