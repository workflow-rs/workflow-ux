...
extern "C" {
    ...
    pub fn set_timeout(
        closure: &Closure<dyn FnMut() -> Result<()>>,
        timeout: u32,
...
impl FunctionDebounce {
    ...
    fn run_callback(&self) -> Result<()> {
        ...
        let args = locked
            .cb_args
            .clone()
            .unwrap_or(FunctionDebounceCallbackArgs::None);
        match args {
            FunctionDebounceCallbackArgs::String(str) => match &mut locked.cb {
            ...
            FunctionDebounceCallbackArgs::Usize(n) => match &mut locked.cb {
            ...
            FunctionDebounceCallbackArgs::None => match &mut locked.cb {
